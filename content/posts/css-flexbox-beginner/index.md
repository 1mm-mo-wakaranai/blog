...
CSSで横並びにしたいのに全然うまくいかない…。floatとか意味分からないし…
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
floatはもう古いよ。今はFlexboxを使えば、たった3行で横並びにできるんだ。基本パターンを覚えれば大体のレイアウトは作れるよ。
{{< /chat >}}
...
{{< chat name="初心者ちゃん" icon="/images/rin-icon.png" direction="left" >}}
display: flexだけでこんなに変わるんだ…！もうfloat使わなくていいんだね。
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
うん、Flexboxだけで9割のレイアウトは対応できる。justify-contentとalign-itemsの2つを覚えれば最強だよ。
{{< /chat >}}
