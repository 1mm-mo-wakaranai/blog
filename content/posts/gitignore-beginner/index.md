...
.gitignoreって何？なんでファイルを無視する必要があるの？
{{< /chat >}}
...
![すでに追跡されているファイルを無視する方法](images/step-guide.png)
...
{{< chat name="初心者ちゃん" icon="/images/rin-icon.png" direction="left" >}}
node_modulesをpushしちゃう前に知れてよかった…！
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
あるあるの失敗だよ。プロジェクト作ったら最初に.gitignoreを設定する癖をつけておこう。
{{< /chat >}}
