...
VS Code 1.21のアップデートって何が変わったの？便利な新機能ある？
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
いくつか実用的な機能が追加されたよ。特に使えそうなものをピックアップして紹介するね。
{{< /chat >}}
...
{{< chat name="初心者ちゃん" icon="/images/rin-icon.png" direction="left" >}}
知らない間にこんな機能増えてたんだ…！設定見直してみよう。
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
VS Codeは毎月アップデートがあるから、リリースノートをたまにチェックすると発見があるよ。
{{< /chat >}}
