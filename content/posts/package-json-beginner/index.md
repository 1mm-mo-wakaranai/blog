...
package.jsonって何が書いてあるの？触っていいの？壊れない？
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
プロジェクトの設定書みたいなものだよ。依存パッケージやスクリプトが書いてある。読み方を覚えれば怖くないよ。
{{< /chat >}}
...
{{< chat name="初心者ちゃん" icon="/images/rin-icon.png" direction="left" >}}
scriptsのところに自分でコマンド追加できるんだ…！npm run buildの正体が分かった。
{{< /chat >}}

{{< chat name="全知全能くん" icon="/images/zenchi-icon.png" direction="right" >}}
そう、npm run xxxはscriptsに書いてあるコマンドを実行してるだけなんだ。自分で追加もできるよ。
{{< /chat >}}
